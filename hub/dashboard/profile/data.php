...
require("../../../cf.php");
	...
	if (isset($_POST['getData'])) {
		...
		$username = $cf->real_escape_string($_POST['username']);
        $check_question = mysqli_query($cf, "SELECT * FROM account, question WHERE account.username = question.username AND question.username = '$username' ORDER BY question.id DESC LIMIT $start, $limit");
