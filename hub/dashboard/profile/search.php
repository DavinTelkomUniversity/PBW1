...
require("../../../cf.php"); 
    if (isset($_POST['search'])) {
        $user = $_POST['user'];
        $check_question = mysqli_query($cf, "SELECT * FROM account, question WHERE account.username = question.username AND question.username = '$user' AND question.title LIKE '%".$_POST['search']."%' ORDER BY question.id DESC");
