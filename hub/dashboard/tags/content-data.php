...
require("../../../cf.php");
	...
	if (isset($_POST['getData'])) {
        ...
        $check_question = mysqli_query($cf, "SELECT * FROM account, question WHERE account.username = question.username AND question.tags LIKE '%$code%' ORDER BY RAND() LIMIT $start, $limit");
