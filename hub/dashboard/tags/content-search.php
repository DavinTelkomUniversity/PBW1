...
require("../../../cf.php");
    if (isset($_POST['search'])) {
        ...
        $check_question = mysqli_query($cf, "SELECT * FROM account, question WHERE account.username = question.username AND question.tags LIKE '%$code%' AND question.title LIKE '%".$_POST['search']."%' ORDER BY RAND()");
